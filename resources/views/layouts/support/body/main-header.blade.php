    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-header">
                    <div class="media">
                        <div class="media-body">
                            <h5 class="mt-0 mb-0">{{Auth::guard('support')->user()->name}}</h5>
                             <span>{{Auth::guard('support')->user()->email}}</span>
                        </div>
                    </div>
                </div>
                ...
                <form id="logout-form" action="{{ route('support.logout') }}" method="get" class="d-none">
                    @csrf
                </form>
